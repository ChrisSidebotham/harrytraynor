...
To insert an emoji using short codes all you need to do is to put the emoji name into some brackets like so - (muscle) = 💪. Now you might be thinking how do I find my favourite emojis? Simply use the emoji selector, hover over one of them and it will display a tooltip with its name - this is what you put in the brackets.
